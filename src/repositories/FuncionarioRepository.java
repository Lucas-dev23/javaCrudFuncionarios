...
public class FuncionarioRepository {
	...
	public void update(Funcionario funcionario) throws Exception {
		...
		// Obtendo uma conexão com o banco de dados
		Connection connection = ConnectionFactory.getConnection();
		// escrever o comando SQL para realizar a atualização de Funcionário
		PreparedStatement statement = connection
	...
	public void delete(Funcionario funcionario) throws Exception {
		...
		// escrever o comando SQL para realizar a exclusão de funcionario
	...
	public List<Funcionario> findAll() throws Exception {
		...
		// Escrevendo uma instrução SQL para consultar todos os funcionario
	...
	// Busca um funcionário no banco de dados pelo ID.
	public Funcionario findById(UUID id) throws Exception {

		Connection connection = ConnectionFactory.getConnection();

		// Escrevendo uma instrução SQL para consultar 1 funcionario através do id
